...
[![GitHub actions status](https://github.com/cuspuk/workflow_respiratory/workflows/Tests/badge.svg?branch=main)](https://github.com/cuspuk/workflow_respiratory/actions?query=branch%3Amain+workflow%3ATests)
...
```bash
mamba create -c conda-forge -c bioconda --name snakemake_covid_patient snakemake=7.25 peppy snakemake-wrapper-utils
```
